...
const style = {
  wrapper: `relative`,
  container: `before:content-[''] before:bg-red-500 before:absolute before:top-0 before:left-0 before:right-0 before:bottom-0 before:bg-[url('https://storage.googleapis.com/opensea-prod.appspot.com/files/CloneX_Feature_550x367_opensea_homepage_UNFORGED_20220831.jpg')] before:bg-cover before:bg-center before:opacity-30 before:blur`,
          ...
          <div className={style.cardContainer}>
            ...
            <div className={style.infoContainer}>
              ...
              <div className={style.author}>
                <div className={style.name}>RTFKT</div>
